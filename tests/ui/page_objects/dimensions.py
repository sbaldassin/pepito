...
class DimensionsDataPage:
    ...
    customer_remove_btn_locator = (By.CLASS_NAME, "icon-cross3")
    ...
    game_remove_btn_locator = (By.XPATH, "(//i[@class='icon-cross3'])[4]")
    ...
    remove_freespin_btn_locator = (By.XPATH, "(//i[@class='icon-cross3'])[3]")
    ...
    customer_name_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerName']")
    customer_surname_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerSurname']")
    customer_zipcode_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerZip']")
    customer_state_btn_locator = (By.XPATH, "//button[@data-id='ddlState']")
    customer_city_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerCity']")
    ...
    customer_date_of_birth_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerDOB']")
    customer_mobile_phone_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerMobile']")
    customer_sign_up_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerSignUp']")
    customer_language_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerLanguage']")
    customer_timezone_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerTimezone']")
    customer_custom_int_1_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerCustomInt1']")
    customer_custom_int_2_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerCustomInt2']")
    customer_custom_int_3_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerCustomInt3']")
    customer_custom_int_4_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerCustomInt4']")
    customer_custom_string_1_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerCustomString1']")
    customer_custom_string_2_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerCustomString2']")
    customer_custom_string_3_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerCustomString3']")
    customer_custom_string_4_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerCustomString4']")
    customer_custom_btag_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerBtag']")
    customer_custom_optout_1_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerOptOut1']")
    customer_custom_optout_2_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerOptOut2']")
    customer_custom_optout_3_btn_locator = (By.XPATH, "//button[@data-id='ddlCustomerOptOut3']")
    customer_map_save_btn_locator = (By.XPATH, "//div[contains(@id,'fileDimCustomersMapSave')]/button")
    clear_customer_map_btn_locator = "ClearMapping(1)"
    clear_bonuses_map_btn_locator = "ClearMapping(2)"
    clear_freespin_map_btn_locator = "ClearMapping(3)"
    clear_game_map_btn_locator = "ClearMapping(4)"
    ...
    remove_bonuses_btn_locator = (By.XPATH, "(//i[@class='icon-cross3'])[2]")
...
class FactsDataPage:
    ...
    upload_lottery_wagers_data_section_locator = (By.XPATH, "//*[contains(text(), 'Upload Lottery Wager Data')]")
    upload_sport_wagers_data_section_locator = (By.XPATH, "//*[contains(text(), 'Upload Sports Wager Data')]")
    ...
    browse_sports_wager_map_locator = (By.ID, "fileFactWagersSportsMap")
    browse_lottery_wager_map_locator = (By.ID, "fileFactWagersLotteryMap")

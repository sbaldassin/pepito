...
class WagerEsportTestCase(TestCase):

    def setUp(self):
        super(WagerEsportTestCase, self)

    def test_tc_1_player_wager_esport(self):
    ...
    def _create_wagers(player, wagers=[]):
        ...
        response = requests.post(get_wager_esport_resource(),
